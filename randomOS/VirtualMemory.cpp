...
uint8_t VirtualMemory::updateSwapFilePage(int pid, int pageNumber, VirtualMemory::Page page) {
...
std::pair<uint8_t, VirtualMemory::Page> VirtualMemory::getPage(int pid, int pageNumber) {
