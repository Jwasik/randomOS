...
private:
	...
	void CFI(); //Stwórz plik                               (15  | 0x0F)
	void DFI(); //Usuñ plik                                 (16  | 0x10)
	void OFI(); //Otwórz plik                               (17  | 0x11)
	...
	void LFI(); //Odczytaj d³ugoœæ pliku					(24  | 0x18)
	void CPR(); //Stwórz proces                             (25  | 0x19)
